...
{{--                        <div class="badge bg-primary rounded-pill ms-auto">5</div>--}}
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item {{ $rcldt ?? '' }}">
                            <a href="/dashboard/reclamations-data" class="menu-link">
                                <div data-i18n="Avis"></div>
                            </a>
                        </li>
                        <li class="menu-item {{ $avisdt ?? '' }}">
                            <a href="/dashboard/avis-data" class="menu-link">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="{{url('assets/backend/img/avatars/1.png')}}" alt class="h-auto rounded-circle" />
                                                    </div>
                                                </div>
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="{{url('assets/backend/img/avatars/2.png')}}" alt class="h-auto rounded-circle" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    ></span>
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="{{url('assets/backend/img/avatars/9.png')}}" alt class="h-auto rounded-circle" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    ></span>
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="{{url('assets/backend/img/avatars/5.png')}}" alt class="h-auto rounded-circle" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar">
                                                        <img src="{{url('assets/backend/img/avatars/6.png')}}" alt class="h-auto rounded-circle" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
