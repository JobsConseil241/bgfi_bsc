...
<head>
    ...
    <title>Une Reclamation Ajoutée</title>
    <style>
        body {
...
<div class="email-container">
    ...
    <div class="email-header">
        <h1>Reclamation du Client</h1>
    </div>

    <!-- Corps de l'email -->
    <div class="email-body">
        <h2>Bonjour M/Mme {{ $user->name }} ,</h2>
        <p>Une nouvelle reclamation a été soumise par un utilisateur, Voici les détails de la reclamation :</p>
        ...
        <p style="text-align: center;">
            <a href="{{ route('RecapitulatifReclamation') }}" class="button" style="text-decoration: none; color: white">Tableau de Board</a>
        </p>
