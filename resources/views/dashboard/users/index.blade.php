        ...
        <div class="row">
            ...
            <div class="offcanvas offcanvas-end" id="add-new-record">
                <div class="offcanvas-header border-bottom">
                    <h5 class="offcanvas-title" id="exampleModalLabel">Nouvel Utilisateur</h5>
                    <button
                        type="button"
...
{{--                            <h5 class="modal-title" id="modalCenterTitle">Modifier l'utilisateur</h5>--}}
{{--                            <button--}}
{{--                                type="button"--}}
{{--                                class="btn-close"--}}
...
{{--            </div>--}}
    ...
    @push('scripts')
        <script>
             ...
             * DataTables Basic
             */
            let agences = {!! json_encode($users, JSON_UNESCAPED_SLASHES ); !!};
