        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Reclamations - Champ Formulaire</li>
                </ol>
            </nav>
                ...
                $('.datatables-basic tbody').on('click', '.delete-record', function () {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: async (login) => {
                            try{
                                const url = '/dashboard/formulaire/reclamation/'+ rowData.id_formulaire + '/champs/' + rowData.id + '/delete';
