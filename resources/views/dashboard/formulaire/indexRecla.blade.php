...
@section('content')
        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    {{--                    </li>--}}
                    <li class="breadcrumb-item active">Reclamations - Formulaire</li>
                </ol>
            </nav>
            ...
            <div class="offcanvas offcanvas-end" id="add-new-record">
                <div class="offcanvas-header border-bottom">
                    <h5 class="offcanvas-title" id="exampleModalLabel">Nouvel Formulaire</h5>
                    <button
                        type="button"
                ...
                <div class="offcanvas-body flex-grow-1">
                    <form class="add-new-record pt-0 row g-2" id="form-add-new-record" method="post" action="{{route('addFormRecla')}}">
                        @csrf
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12 mt-3">
                            <label for="description" class="form-label">Details sur le formulaire</label>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalCenterTitle">Modifier les Paramètres du formulaires</h5>
                            <button
                                type="button"
                                class="btn-close"
                        ...
                        <form class="add-new-record pt-0 row g-2" id="editForm" method="post" action="{{ route('editFormRecla') }}">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="col-sm-12 mt-3">
                                    <label for="descriptione" class="form-label">Details sur le formulaire</label>
                                    <textarea class="form-control" id="descriptione" rows="3" name="description"></textarea>
                                </div>
                                <input
                                    type="number"
                                    id="id"
    ...
    @push('scripts')
        <script>
             ...
             * DataTables Basic
             */
            let agences = {!! json_encode($datas, JSON_UNESCAPED_SLASHES ); !!};
            ...
            $(function () {
                ...
                if (dt_basic_table.length) {
                    dt_basic = dt_basic_table.DataTable({
                        ...
                        buttons: [
                            ...
                            {
                                text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Ajouter Un formulaire</span>',
                    ...
                    $('div.head-label').html('<h5 class="card-title mb-0">Liste des Formulaires</h5>');
                }
                ...
                $('.datatables-basic tbody').on('click', '.delete-record', function () {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: async (login) => {
                            try{
                                const url = '/dashboard/formulaire/reclamation/'+ rowData.id +'/delete';
                ...
                $('.datatables-basic ').on('click', '.add-res', function() {
                    ...
                    window.location.replace("/dashboard/formulaire/reclamation/"+rowData.id);
                });
