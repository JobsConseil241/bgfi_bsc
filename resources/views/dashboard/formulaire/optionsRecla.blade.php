        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('indexFormRecla') }}">Reclamations - Formulaire</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="{{ route('indexFormReclae', ['id' => $formulaire->id]) }}">Reclamations - Champ Formulaire</a>
                    </li>
                    <li class="breadcrumb-item active">Reclamations - Options Champ Formulaire</li>
                </ol>
            </nav>
        ...
        <script>
            ...
            $(function () {
                ...
                $('.datatables-basic tbody').on('click', '.delete-record', function () {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: async (login) => {
                            try{
                                const url = '/dashboard/formulaire/reclamation/'+ rowData.id_form + '/options/' + rowData.id_champ + '/value/' + rowData.id +  '/delete';
                ...
                $('.datatables-basic ').on('click', '.add-res', function() {
                    ...
                    window.location.replace("/dashboard/formulaire/reclamation/"+rowData.id_formulaire +"/options/" + rowData.id );
                });
