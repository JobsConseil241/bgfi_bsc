...
{{--                    </li>--}}
            ...
            <div class="offcanvas offcanvas-end" id="add-new-record">
                ...
                <div class="offcanvas-body flex-grow-1">
                    <form class="add-new-record pt-0 row g-2" id="form-add-new-record" method="post" action="{{route('addFormAvis')}}">
                        @csrf
                        <div class="col-sm-12">
            ...
            <div class="modal fade" id="EditModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form class="add-new-record pt-0 row g-2" id="editForm" method="post" action="{{ route('editFormAvis') }}">
                            @csrf
        ...
        <script>
            ...
            $(function () {
                ...
                $('.datatables-basic ').on('click', '.add-res', function() {
                    ...
                    window.location.replace("/dashboard/formulaire/avis/"+rowData.id);
                });
